        ...
        sections: [{
            ...
            children: [
                ...
                new Paragraph({
                    children: [
                        new TextRun({
                            text: "TRỢ LÝ SKKN AN PHÚ 3 - Thẩm Định SKKN",
                            italics: true,
                            size: 20,
                            color: "6B7280"
                        })
                ...
                new Paragraph({
                    children: [
                        new TextRun({
                            text: `Báo cáo được tạo bởi TRỢ LÝ SKKN AN PHÚ 3 - ${new Date().toLocaleDateString('vi-VN')}`,
                            size: 18,
                            color: "9CA3AF",
                            italics: true
                        })
...
function createScoreTable(result: AnalysisResult): Table {
    return new Table({
        ...
        rows: [
            ...
            createScoreRow("Tính khoa học", result.scores.scientific, 10),
            createScoreRow("Tính thực tiễn", result.scores.practicality, 20),
            createScoreRow("Tính hiệu quả", result.scores.effectiveness, 30),
